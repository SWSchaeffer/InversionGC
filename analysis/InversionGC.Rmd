...
Input: 
* “AR_REF_Chr3.fas”, the v3.2 reference sequence for chromosome 3 in D. pseudoobscura. 
* “Chr3_FB_SnpTable.tsv” SNP table from FreeBayes Analysis of 54 strains of D. pseudoobscura and 1 strain of the outgroup D. miranda.
	
Output: 
* “StrainName_Chr3.fas”, where StrainName is the name of the strain.  The FASTA files used in the analysis are stored in the data/FASTA Files folder.
